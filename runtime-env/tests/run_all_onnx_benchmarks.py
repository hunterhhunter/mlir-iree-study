...
BENCHMARK_CONFIGS = [
    ...
    },
    {
        ...
        "dataset": "datasets/baked_numpy/sst2",
        "extra_args": [],
        "required_files": [
            "models/google-bert_bert-base-uncased/model.onnx",
            "datasets/baked_numpy/sst2/input_ids.npy",
            "datasets/baked_numpy/sst2/labels.npy",
        ],
    ...
    },
    {
        ...
        "dataset": "datasets/baked_numpy/squad_val",
        "extra_args": [],
        "required_files": [
            "models/bert-base-uncased-squad-v1/squad.onnx",
            "datasets/baked_numpy/squad_val/input_ids.npy",
            "datasets/baked_numpy/squad_val/start_positions.npy",
        ],
