"""
Download meta-llama/Llama-3.1-8B from Hugging Face Hub and optionally convert to ONNX.
Usage:
    python models/prepare_llama_3_1_8b.py
    python models/prepare_llama_3_1_8b.py --format onnx
    python models/prepare_llama_3_1_8b.py --output /path/to/models
    python models/prepare_llama_3_1_8b.py --convert-onnx
    python models/prepare_llama_3_1_8b.py --convert-onnx --dtype fp16
    python models/prepare_llama_3_1_8b.py --convert-onnx --no-post-process
"""
import sys
import os
import subprocess
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Download Llama-3.1-8B from Hugging Face and optionally convert to ONNX")
